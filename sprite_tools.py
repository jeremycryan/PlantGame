...
class SpriteSheet(object):
    ...
    def __init__(self, surface, sheet_size, frame_num):
...
class Sprite(object):
    ...
    def get_size(self):
        ...
        width = self.animations[self.active_animation].get_frame(0).get_width()
        height = self.animations[self.active_animation].get_frame(0).get_height()
        return (width, height)
